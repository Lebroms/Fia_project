...
class RandomSubsamplingValidation:
    ...
    def evaluate(self, X, y, knn_model):
        ...
        for _ in range(self.num_experiments):  # Ripetiamo per ogni esperimento
            ...
            # Addestriamo il modello KNN sui dati di training
            Classificatore_KNN.converti_in_array(X_train, y_train)

            # Facciamo la predizione sui dati di test
            y_pred = Classificatore_KNN.predict(X_test)